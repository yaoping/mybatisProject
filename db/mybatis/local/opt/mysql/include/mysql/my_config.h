...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mysql/5.7.11"
#define SHAREDIR "/usr/local/Cellar/mysql/5.7.11/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mysql/5.7.11"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define MYSQL_KEYRINGDIR "/usr/local/Cellar/mysql/5.7.11/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mysql/5.7.11"
#define PLUGINDIR "/usr/local/Cellar/mysql/5.7.11/lib/plugin"
...
#define DEFAULT_EARLY_PLUGIN_LOAD "keyring_file=keyring_file.so"
